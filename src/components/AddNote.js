    ...
    <div className='container'>
      ...
      <form >
          <div className="form-group">
            ...
            <input type="texxt" className="form-control" id="title" name='title' value={note.title} aria-describedby="emailHelp" placeholder="Enter title" onChange={onChange} minLength={5} required/>
