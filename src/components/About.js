            ...
            <div>
                <div className="text-white aboutImg text-center">
                    <div className="note-img">
                        <h1 className="flex">Empowering Students</h1>
                        <p>
                ...
                <div className="container mt-5 ">
                    <div className="row">
                        <div className="col-md-6 d-flex flex-column justify-content-center">
                            <h2 className="mb-3" style={{ fontWeight: "Bold" }}>
                                Make something <span style={{ color: "#9C27B0" }}>
                                    Awesome
                                </span>{" "}
                            </h2>
                            <p>
                                ...
                                disturbances. you can also access your notes anywhere in your
                                world, at anytime time . So don't forget to Create note because
                    ...
                    <div className="row login mt-5 mb-5">
                        ...
                        <div className="col-md-6 d-flex flex-column justify-content-center">
                            ...
                            <p>
                                How we started? The concept was simple. iNotebook was born from
                    ...
                    <div className="bottom-details">
                        <div className="bottom_text">
                            <span className="copyright_text">
                                Copyright © 2021 <Link to="/">iNotebook</Link>All rights
                                reserved
                            </span>
